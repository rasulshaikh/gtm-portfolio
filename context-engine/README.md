...
1. **Signal Activation** (workflows.io) - 11 steps from capture to Smartlead/HeyReach/Slack
...
5. **Cold Outreach Message** (Rasul-owned, inspired by workflows.io) - 5 steps: first line, body, CTA, P.S., 80-word gate
